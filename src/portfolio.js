...
const greeting = {
  ...
  title2: "Rajnish",
  logo_name: "Rajnish.M()",
  nickname: "rajnish / Rahul",
  full_name: "Rajnish Mishra",
  subTitle:
...
const socialMediaLinks = {
  ...
  github: "https://github.com/RAJNISHMSHRA",
  linkedin: "https://www.linkedin.com/in/rajnish-mishra97/",
  ...
  data: [
    {
      ...
      skills: [
        ...
        "⚡ Backend development using NodeJS, ExpressJS and js",
      ],
      softwareSkills: [
        {
          skillName: "HTML5",
...

    {
      ...
      skills: [
        "⚡ Proficient in team management and lead team for development",
        "⚡ Took oer 50+ interviews for my organization helping them to hire skilled team mamtes",
        `⚡ Demonstrated througheffective delegation, conflict resolution, and fostering a collaborative
        work enviroment to achieve project objective efficiently`,
        "⚡ Experience hosting and managing web apps on GCP and AWS",
        "⚡ Deploying dWeb applications and job on cloud to use on mobile devices",
      ],
      softwareSkills: [
        {
          skillName: "GCP",
...
const degrees = {
  degrees: [
    {
      title: "Shri Shankaracharya Group of Institutions",
      ...
      descriptions: [
        ...
        "⚡ I have also completed various online courses for react/node/micro services, Web Development, Mobile App Development, etc.",
        "⚡ I have implemented several projects based on what I've learnt under my Computer Engineering course. ",
      ],
      website_link: "https://www.sstc.ac.in/",
    },
    {
      title: "Tulsi Vidya Niketan",
      subtitle: "Inter secondary school",
      logo_path: "tvn.jfif",
      alt_name: "TVN",
      duration: "2013 - 2014",
      descriptions: [
        "⚡ Studied MAth,Science and physics for higher eduction",
        "⚡ Learn Advanced Topics in computing and c++ in computer classes",
        "⚡ Performed extra activities and build php application in demonstration",
        "⚡ Won 2nd prize for practicals and computer skills.",
      ],
      website_link: "https://www.tvnschools.com/",
    },
  ],
};
...
const certifications = {
  certifications: [
    {
      title: "Meta Front End Developer Associate",
      subtitle: "Front End",
      logo_path: "intro.PNG",
      certificate_link: "#",
      alt_name: "Front End",
...
const experience = {
  title: "Experience",
  subtitle: "Professional Work, Internship and Volunteership",
  description:
    "I have 4+ years of working with MNC's. I've been involved in global projects and Contributing in team as group/ Individual. I love Creating FrontEnd and Backend applications using Mern",
      ...
      experiences: [
        {
          ...
          company: "Tredence ",
          company_url: "https://www.tredence.com/",
          logo_path: "tredence.png",
          duration: "May 2022 - Ongoing",
          location: "Bangalore, Karnataka",
          description:
            "At Tredence, we bridge the gap between insights delivery and value realization by enabling last-mile adoption of data science.",
          color: "#f10000",
        },
        {
          ...
          logo_path: "cerner.png",
          duration: "Oct 2021 - April 2022",
          location: "Bangalore",
          description:
            "Oracle Cerner   provides various health information technologies, ranging from medical devices to electronic health records (EHR) to hardware.",
          color: "#2962FF",
        },
        {
          title: "Full Stack Developer",
          company: "Merck LifeScience",
          company_url:
            "https://www.merckgroup.com/en/expertise/life-science.html",
          logo_path: "mercklifescience.jpg",
          duration: "Sept 2019 - sept 2021",
          location: "Bangalore",
          description: `offering solutions in Healthcare, Life Science and Electronics. Join our team and shape the future. At Merck, we pursue solutions that have a positive impact on 
            our future.`,
          color: "#2962FF",
        },
      ],
      ...
      experiences: [
        {
          ...
          company_url: "https://iitbhu.ac.in/",
          logo_path: "iitbhu.png",
...
const projectsHeader = {
  title: "Projects",
  description:
    "My projects makes use of vast variety of latest technology tools. My best experience is to create Global web application. Below are some of my projects. Note that not all of the mentioned projects/professional are on GitHub yet.",
...
const contactPageData = {
  contactSection: {
    title: "Contact Me",
    profile_image_path: "rajnishmishra.png",
    description:
